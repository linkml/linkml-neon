# Contributing to neon-schema

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
neon-schema. These guidelines are not strict rules.
...
The neon-schema team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the neon-schema technical leads
...
[issues]: https://github.com/diatomsRcool/neon-schema/issues/
[pulls]: https://github.com/diatomsRcool/neon-schema/pulls/
